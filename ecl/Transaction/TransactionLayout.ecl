/* Copyright (C) DataSeers, Inc - All Rights Reserved
* Unauthorized copying of this file, via any medium is strictly prohibited
* Proprietary and confidential for more details about copyright and licensing
* can be found in license.txt
* Written by Gurjot Kaur Bandasha <gbandasha@dataseers.us>, August 2018
*/

IMPORT STD;
EXPORT TransactionLayout := RECORD
  unsigned8 unique_id;
